...
def main():
    ...
    output_dir = "output/planets/examples/generate_planet"
    os.makedirs(output_dir, exist_ok=True)
    planet.save(os.path.join(output_dir, f"desert_planet_{seed}.png"))
    print(f"Saved to {output_dir}/desert_planet_{seed}.png")
    ...
    print(f"Saved to {output_dir}/planet_container.png using container")
    ...
    print(f"Saved to {output_dir}/planet_container_rotated.png using container with rotation")
