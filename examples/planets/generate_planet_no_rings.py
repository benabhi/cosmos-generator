...
def main():
    ...
    output_dir = "output/planets/examples/generate_planet_no_rings"
    os.makedirs(output_dir, exist_ok=True)
    planet.save(os.path.join(output_dir, f"desert_planet_no_rings_{seed}.png"))
    print(f"Saved to {output_dir}/desert_planet_no_rings_{seed}.png")
    ...
    print(f"Saved to {output_dir}/planet_no_rings_container.png using container")
    ...
    print(f"Saved to {output_dir}/planet_no_rings_container_rotated.png using container with rotation")
