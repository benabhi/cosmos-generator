#!/usr/bin/env python3
"""
Test script to verify the zoom functionality with a larger canvas.
"""
import os
import sys
...
def main():
    ...
    output_dir = "output/planets/examples/test_zoom_larger_canvas"
    os.makedirs(output_dir, exist_ok=True)

    # Define zoom levels to test
    zoom_levels = [0.0, 0.5, 1.0, None]  # None for default
