"""
Tests for the Jungle planet type.
"""
import pytest
from PIL import Image
import numpy as np

from cosmos_generator.celestial_bodies.planets.jungle import JunglePlanet
...
class TestJunglePlanet:
    """Test suite for the Jungle planet type."""

    def test_jungle_planet_creation(self):
        """Test that a Jungle planet can be created with default parameters."""
        planet = JunglePlanet(seed=12345)
        assert planet is not None
        assert planet.PLANET_TYPE == "Jungle"
        assert planet.variation == "overgrown"  # Default variation

    def test_jungle_planet_variations(self):
        """Test that all Jungle planet variations can be created."""
        variations = ["overgrown", "canopy", "bioluminescent"]
        for variation in variations:
            planet = JunglePlanet(seed=12345, variation=variation)
            assert planet.variation == variation

    def test_jungle_planet_texture_generation(self):
        """Test that Jungle planet textures can be generated for all variations."""
        variations = ["overgrown", "canopy", "bioluminescent"]
        for variation in variations:
            planet = JunglePlanet(seed=12345, variation=variation)
    ...
    def test_jungle_planet_with_container(self):
        """Test that a Jungle planet can be rendered in a container."""
        planet = JunglePlanet(seed=12345)
        container = Container()
    ...
    def test_jungle_planet_with_atmosphere(self):
        """Test that a Jungle planet can be rendered with atmosphere."""
        planet = JunglePlanet(seed=12345, atmosphere=True)
        container = Container()
        container.set_content(planet)
        image = container.render()
        assert isinstance(image, Image.Image)
    ...
    def test_jungle_planet_with_rings(self):
        """Test that a Jungle planet can be rendered with rings."""
        planet = JunglePlanet(seed=12345, rings=True)
        container = Container()
        container.set_content(planet)
        image = container.render()
        assert isinstance(image, Image.Image)
    ...
    def test_jungle_planet_with_clouds(self):
        """Test that a Jungle planet can be rendered with clouds."""
        planet = JunglePlanet(seed=12345, cloud_coverage=0.5)
        container = Container()
        container.set_content(planet)
        image = container.render()
        assert isinstance(image, Image.Image)
    ...
    def test_jungle_planet_with_all_features(self):
        """Test that a Jungle planet can be rendered with all features."""
        planet = JunglePlanet(
            seed=12345,
            atmosphere=True,
            rings=True,
    ...
    def test_jungle_planet_different_variations_with_features(self):
        """Test that all Jungle planet variations can be rendered with features."""
        variations = ["overgrown", "canopy", "bioluminescent"]
        for variation in variations:
            planet = JunglePlanet(
                seed=12345,
    ...
    def test_jungle_planet_different_seeds(self):
        """Test that Jungle planets with different seeds look different."""
        planet1 = JunglePlanet(seed=12345)
        planet2 = JunglePlanet(seed=54321)
    ...
    def test_jungle_planet_zoom_levels(self):
        """Test that Jungle planets can be rendered at different zoom levels."""
        planet = JunglePlanet(seed=12345)
        ...
        planet_with_rings = JunglePlanet(seed=12345, rings=True)
    ...
    def test_jungle_planet_color_palettes(self):
        """Test that a Jungle planet can use different color palettes."""
        # Test color palette 1
        planet1 = JunglePlanet(seed=12345, color_palette_id=1)
        assert planet1.color_palette_id == 1

        # Test color palette 2
        planet2 = JunglePlanet(seed=12345, color_palette_id=2)
        assert planet2.color_palette_id == 2

        # Test color palette 3
        planet3 = JunglePlanet(seed=12345, color_palette_id=3)
